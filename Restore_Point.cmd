...
sc config "Explorer" start= disabled
sc stop VSS
...
powershell -ExecutionPolicy Unrestricted -NoProfile Checkpoint-Computer -Description 'serpent1019 + Nexus'
sc config "Explorer" start= auto
net start "Explorer"
